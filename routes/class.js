...
const { createClass,joinClass,classes,uploadAssignment,uploadResult,classInfo,deleteClass, uploadMessage ,deleteMessage ,deleteAssignment ,deleteResult ,getAttendence} = require('../controllers/class');
...
router.get("/attendence/:classId/:date",isRequestValidated, requireSignin,getAttendence);
